...
<head>
    ...
    <title>My Cart - Joy Music Corner</title>
...
<body>
    ...
    <div class="cart-container">
        ...
        <!-- Product 1 -->
        <div class="cart-item">
            <img src="https://d1b5h9psu9yexj.cloudfront.net/57440/Anker-s-Soundcore-Space-One_20230829-151132_full.jpeg" alt="Noise-Cancelling Headphones">
            <div class="item-details">
                <h3>Noise-Cancelling Headphones</h3>
                <p>Immerse yourself in music with active noise cancellation.</p>
                <span class="price">RS.12000.00</span>
                <div class="quantity">
                    <button>-</button>
        ...
        <!-- Product 2 -->
        <div class="cart-item">
            <img src="https://celltronics.lk/wp-content/uploads/2024/02/Baseus-AeQur-G10-True-Wireless-Earbuds.jpg" alt="Over-Ear Studio Headphones">
            <div class="item-details">
                <h3>Over-Ear Studio Headphones</h3>
                <p>High-fidelity audio for professionals.</p>
                <span class="price">RS.8000.00</span>
                <div class="quantity">
                    <button>-</button>
                    <input type="text" value="1">
                    <button>+</button>
        ...
        <div class="total-price">
            <h3>Total Price: <span>RS.20000.00</span></h3>
